...
# ✅ 根据 RENDER 正确设置 silent_mode
if RENDER:
    env = SnakeEnv(seed=seed, limit_step=False, silent_mode=False)  # 显示窗口
else:
    env = SnakeEnv(seed=seed, limit_step=False, silent_mode=True)   # 静默模式
